...
from .user_trips_api import (
    ...
    UserTourPlanDetailView,
    UserTourItineraryDetailView,
)
...
urlpatterns = [
    ...
    path('user/tour_plans/<str:user_id>/trip/<int:trip_id>/', UserTourPlanDetailView.as_view(), name='user-tour-plan-detail'),
    path('user/tour_itineraries/', UserTourItineraryView.as_view(), name='user-tour-itineraries'),
    path('user/tour_itineraries/trip/<int:trip_id>/seq/<int:seq>/', UserTourItineraryDetailView.as_view(), name='user-tour-itinerary-detail'),
