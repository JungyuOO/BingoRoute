"""
Django settings for service.config project.
...
# Load .env files from common locations without overriding explicit env vars
load_dotenv()
for env_path in (
    PROJECT_ROOT / ".env",
    REPO_ROOT / ".env",
...
ROOT_URLCONF = 'service.config.urls'
...
WSGI_APPLICATION = 'service.config.wsgi.application'
